...
var INFO_CONTENT={
  sobre:{
    ...
    tabs:[
      {label:'Sobre',body:`<div class="info-section-title"><span class="info-icon">ℹ️</span>Sobre o Urubu FC</div>
...
<p>O Urubu FC não tem vínculo oficial com o Clube de Regatas do Flamengo. É um projeto independente, feito por um torcedor comum para ser compartilhado com outros torcedores.</p>`},
      {label:'Metodologia',body:`<div class="info-section-title"><span class="info-icon">🧮</span>Como funciona o Nível dos jogadores</div>
...
<p>O elenco padrão que vem pré-carregado no site já foi calculado com essa metodologia. Você pode ajustar qualquer nota manualmente a qualquer momento, direto no modal do jogador.</p>`}
  ...
  ajuda:{
    title:'Ajuda',
    tabs:[
      {label:'Como usar',body:`<div class="info-summary" id="ajd-summary">
<a class="info-summary-item" href="#ajd-como-usar" onclick="event.preventDefault();irParaAjuda(0,'ajd-como-usar');"><span class="is-num">1</span><span class="is-ico">🧭</span><span class="is-txt">Como usar</span></a>
<a class="info-summary-item" href="#ajd-faq" onclick="event.preventDefault();irParaAjuda(1,'ajd-faq');"><span class="is-num">2</span><span class="is-ico">❓</span><span class="is-txt">FAQ</span></a>
<a class="info-summary-item" href="#ajd-guia-botoes" onclick="event.preventDefault();irParaAjuda(2,'ajd-guia-botoes');"><span class="is-num">3</span><span class="is-ico">🎮</span><span class="is-txt">Guia de Botões</span></a>
<a class="info-summary-item" href="#ajd-graficos-analise" onclick="event.preventDefault();irParaAjuda(3,'ajd-graficos-analise');"><span class="is-num">4</span><span class="is-ico">📊</span><span class="is-txt">Gráficos da Análise</span></a>
</div>
<div class="info-section-title" id="ajd-como-usar"><span class="info-icon">🧭</span>Como usar o Urubu FC</div>
...
<p><button class="btn btn-ghost" onclick="openOnboarding()">🔄 Rever tutorial de boas-vindas</button></p>`},
      {label:'FAQ',body:`<div class="info-section-title" id="ajd-faq"><span class="info-icon">❓</span>Perguntas frequentes</div>
...
<p>Sim — tem botão de compartilhar que gera uma imagem do campo tático, além de compartilhamento via link.</p>`},
      {label:'Guia de Botões',body:`<div class="info-section-title" id="ajd-guia-botoes"><span class="info-icon">🎮</span>Guia de Botões</div>
<h3><span class="info-icon">⚽</span>Campo Tático</h3>
...
<h3><span class="info-icon">👥</span>Elenco</h3>
...
<h3><span class="info-icon">💰</span>Mercado</h3>
...
<h3><span class="info-icon">📊</span>Análise</h3>
...
<h3><span class="info-icon">📤</span>Compartilhar (menu geral)</h3>
...
<h3><span class="info-icon">📝</span>Modais de edição (jogador e alvo)</h3>
...
<div class="info-btn-item"><div class="ib-title">Cancelar</div>Fecha o formulário sem salvar as alterações feitas.</div>`},
      {label:'Gráficos da Análise',body:`<div class="info-section-title" id="ajd-graficos-analise"><span class="info-icon">📊</span>Sobre os gráficos da Análise</div>
...
// Sumário da aba Ajuda: ativa a sub-aba correspondente (sem fechar/reabrir o
// modal) e rola suavemente até o título de destino.
function irParaAjuda(tabIdx,anchorId){
  var tabGroup=document.querySelector('#info-tabs .info-tabgroup[data-info-type="ajuda"]');
  var panelGroup=document.querySelector('#info-body .info-panelgroup[data-info-type="ajuda"]');
  if(!tabGroup||!panelGroup)return;
  var btns=tabGroup.querySelectorAll('.info-tab-btn');
