...
function renderTable(){
  ...
  if(!document.getElementById('btn-export-roster')){
    ...
    if(tbar){
      ...
      // botão compartilhar link limpo
      const bLinkLimpo=document.createElement('button');
      bLinkLimpo.id='btn-link-limpo';
      bLinkLimpo.className='btn-share';
      bLinkLimpo.title='Copiar link do site';
      bLinkLimpo.innerHTML='🔗 Site';
      bLinkLimpo.onclick=compartilharLinkLimpo;
      tbar.appendChild(bLinkLimpo);
      // botão compartilhar link com escalação
      const bLinkEsc=document.createElement('button');
      bLinkEsc.id='btn-link-escalacao';
      bLinkEsc.className='btn-share';
      bLinkEsc.title='Copiar link com minha escalação';
      bLinkEsc.innerHTML='🔗 Escalação';
      bLinkEsc.onclick=compartilharLinkEscalacao;
      tbar.appendChild(bLinkEsc);
